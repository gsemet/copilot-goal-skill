...
![Goal Skill Workflow](plugins/copilot-goal-skill/skills/goal/assets/goal-loop.svg)
...
```
@copilot-goal-skill Add retry logic to the API client
```

The skill will:
1. Ask you clarifying questions until the goal is clear
2. Write `.agents/changes/request/<id>/goal.md`
